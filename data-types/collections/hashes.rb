...
class HashesTest < Minitest::Test
  ...
  def test_7
    ...
    # in the line below
    books["Ernest Hemingway"] = "For Whom the Bell Tolls"
    expected = {
      "John Steinbeck" => "Grapes of Wrath",
      "Harper Lee" => "To Kill a Mockingbird",
  ...
  def test_11
    ...
    # Using the books hash defined above,
    # add a new key of :Ernest_Hemingway
    # with a value of "For Whom the Bell Tolls"
    # in the line below
    books[:Ernest_Hemingway] = "For Whom the Bell Tolls"
    expected = {
      John_Steinbeck: "Grapes of Wrath",
      Harper_Lee: "To Kill a Mockingbird",
      Ernest_Hemingway: "For Whom the Bell Tolls"
    }
    assert_equal expected, books
  end
